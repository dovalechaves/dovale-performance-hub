...
import { BarChart3, Calculator, LogOut, Sun, Moon, Users, RefreshCw, Loader2, ChevronDown, Settings2, Send, Archive, Bot, Database, ClipboardList, UserPlus, PackageSearch, ShoppingCart } from "lucide-react";
              ...
              <table className="w-full text-sm min-w-[2300px]">
                ...
                <tbody>
                  {usersLoading ? (
                    ...
                    <tr>
                      <td colSpan={28} className="px-4 py-8 text-center text-muted-foreground text-xs">
                        {appUserFilter === "all"
